...
function creeperFeetWalk(){
  walkOffset += 0.04;
  creeperObj.foot1.rotation.x = Math.sin(walkOffset) / 4;
  creeperObj.foot2.rotation.x = -Math.sin(walkOffset) / 4;
  creeperObj.foot3.rotation.x = -Math.sin(walkOffset) / 4;
  creeperObj.foot4.rotation.x = Math.sin(walkOffset) / 4;
}

let scaleHeadOffset = 0
// 膨胀
function creeperScaleBoby(){
